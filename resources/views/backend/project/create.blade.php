...
@section('content')
    <div class="w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-700">Add New Project</h1>
        ...
        <!-- Title -->
            ...
            <div class="mb-4">
                ...
                <textarea name="long_description" id="long_description" rows="6" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('long_description') }}</textarea>
            ...
            <div class="mb-4">
                ...
                <input type="url" name="github_link" id="github_link" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('github_link') }}">
                @error('github_link')
                <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="url" name="web_link" id="web_link" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('web_link') }}">
                @error('web_link')
                <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
